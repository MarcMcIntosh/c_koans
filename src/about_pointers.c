...
Test(about_pointers, pointers_and_addresses)
{
    ...
    */
    ...
    cr_assert_eq(*jptr, j, "What is the value that jptr 'points' to?");
...
Test(about_pointers, pointers_arrays_and_arithmetic)
{
    ...
    */
    ...
    cr_assert_eq(*a,/* a[0] */ 1, "Remember what the ");
    cr_assert_eq(*p1,/* a[0] */ 1, "What does p1 point to?");
    cr_assert_eq(*p2,/* a[1] */ 2, "What does p2 point to?");
    ...
    */
    cr_assert_eq((long)((long)p2 - (long)p1), sizeof(int),
...
Test(about_pointers, function_pointers)
{
    ...
    */
    ...
    {
	    // return strcmp(str1, str2); Breaks
	   /* Works some how */
